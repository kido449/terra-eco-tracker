...
export default function EcoPersonality() {
  ...
  if (showResults && resultData) {
    return <QuizResults resultData={resultData} handleRetake={handleRetake} />;
  }

  const question = quizQuestions[currentQ];

  return <QuizQuestion currentQ={currentQ} totalQuestions={totalQuestions} question={question} handleAnswer={handleAnswer} />;
}

// --- Sub-components ---

function QuizResults({ resultData, handleRetake }) {
  return (
    <div>
...
QuizResults.propTypes = { resultData: PropTypes.object.isRequired, handleRetake: PropTypes.func.isRequired };

function QuizQuestion({ currentQ, totalQuestions, question, handleAnswer }) {
  return (
    <div>
      <PageHeader
...
QuizQuestion.propTypes = { currentQ: PropTypes.number.isRequired, totalQuestions: PropTypes.number.isRequired, question: PropTypes.object.isRequired, handleAnswer: PropTypes.func.isRequired };
